...
const SignIn: React.FC = () => {
  const [typeUser, setTypeUser] = useState<string>("SuperAdmin");
  ...
  const handleSumit = async (e: React.FormEvent) => {
    ...
    try {
      if (typeUser === "SuperAdmin") {
        const res = await axios.post(`${BaseUrl}/superadmin/login`, {
          id,
          password,
        });
        if (res.data.success) {
        ...
        // if (typeUser === "Student") {
        const res = await axios.post(`${BaseUrl}/students/login`, {
          name,
          subject,
        });
        if (res.data.success) {
      ...
      console.error("Error signing in the site :" + error);
      toast.error("Error signing in the site");
    } finally {
      setPassword("");
  ...
  return (
    <>
      <div className="rounded-sm border border-stroke   md:mt-0  bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <Toaster reverseOrder={false} position="top-right" />
        <div className="flex flex-wrap items-center h-screen">
          <div className="hidden w-full  xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <p className="2xl:px-20">Welcome to GD-College . Please LogIn</p>
              {/* For the svg section */};
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2 ">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign In to University
              </h2>

              <p className="text-red-600">
                For test username - <span className="font-bold">AdminTest</span>{" "}
              </p>
              <p className="text-red-600">
              ...
              <form onSubmit={handleSumit}>
                <div className="mb-4">
                  ...
                  <div className="rounded-sm bg-white dark:bg-boxdark pb-4">
                    <select
                      id="type"
                      name="type"
                    ...
                    >
                      ...
                      <option value="SuperAdmin" className="text-gray-600">
                        SuperAdmin
                      </option>
                  ...
                  <div className="mb-5">
                    <button
                      type="submit"
                      className="w-full cursor-pointer font-semibold rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90"
                    >
                      Submit
                    </button>
                  </div>
